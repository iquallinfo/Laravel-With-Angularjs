...
Route::group(array('prefix'=>'/','before'=>'auth.Ui|auth.token|api.csrf'),function(){
    ...
    Route::post('/dashboard/allsubjectList','DashboardController@allsubjectList');
    Route::post('/dashboard/levelpathlevel','DashboardController@levelpathlevel');
    Route::post('/dashboard/selectAssgnOnexm','DashboardController@selectAssgnOnexm');
    Route::post('/dashboard/selectModules','DashboardController@selectModules');
    Route::post('/dashboard/addnewassign','DashboardController@addnewassign');
    Route::post('/dashboard/addnewmodule','DashboardController@addnewmodule');
    Route::get('/dashboard/classStudentlist/{id}','DashboardController@classStudentlist');
    Route::post('/dashboard/addnewexam','DashboardController@addnewexam');
    Route::get('/dashboard/profileImage/{id}','DashboardController@profileImage');
     Route::post('/dashboard/allclassesList','DashboardController@allclassesList');
     Route::get('/dashboard/getLpAssign/{id}','DashboardController@getLpAssign');
     Route::get('/dashboard/getLpOnExam/{id}','DashboardController@getLpOnExam');
    ...
    Route::post('/languages/{id}','LanguagesController@edit');
     ...
     //Languages Field 
	Route::get('/languagesField','DashboardController@index');
	Route::get('/languagesField/listAll','LanguageFieldController@listAll');
	Route::post('/languagesField','LanguageFieldController@create');
	...
	Route::post('/classes/{id}','ClassesController@edit');
        ...
        //My Classes
	Route::get('/myclasses','DashboardController@index');
	Route::get('/myclasses/listAll','MyClassesController@listAll');
	Route::get('/myclasses/subjectslist/{id}','MyClassesController@subjectslist');
        Route::get('/myclasses/studentslist/{classid}/{subid}','MyClassesController@studentslist');
        
        //Classes Grade Setting
	Route::get('/classgrade','DashboardController@index');
	Route::get('/classgrade/listAll','ClassesGradeController@listAll');
	Route::get('/classgrade/gradelist/{id}','ClassesGradeController@gradelist');
        Route::post('/classgrade/addgrade/{classid}','ClassesGradeController@addgrade');
        Route::get('/classgrade/editgrade/{id}','ClassesGradeController@fetchgrade');
        Route::post('/classgrade/editgrade/{id}','ClassesGradeController@editgrade');
        Route::post('/classgrade/delete/{id}','ClassesGradeController@deletegrade');
        
        // year Level
        Route::get('/yearLevel','DashboardController@index');
	Route::get('/yearLevel/listAll','YearLevelController@listAll');
        Route::post('/yearLevel/add','YearLevelController@create');
	Route::get('/yearLevel/edit/{id}','YearLevelController@fetch');
        Route::post('/yearLevel/edit/{id}','YearLevelController@edit');
        Route::post('/yearLevel/delete/{id}','YearLevelController@delete');
        
        //Overrule Grade Setting
	Route::get('/overrulegrade','DashboardController@index');
	Route::get('/overrulegrade/listAll','OverruleGradeController@listAll');
	Route::get('/overrulegrade/subjectslist/{id}','OverruleGradeController@subjectslist');
        Route::get('/overrulegrade/studentslist/{classid}/{subid}','OverruleGradeController@studentslist');
        Route::post('/overrulegrade/addgrade/{classid}/{subid}/{uid}','OverruleGradeController@addgrade');
        Route::get('/overrulegrade/editgrade/{classid}/','OverruleGradeController@fetchrule');
        Route::post('/overrulegrade/editgrade/{ovrid}','OverruleGradeController@editgrade');
        Route::post('/overrulegrade/delete/{id}','OverruleGradeController@deletegrade');
	...
	Route::post('/assignments/{id}','AssignmentsController@edit');
        Route::get('/assignments/giveGrade/{id}','AssignmentsController@viewGrade');
        Route::post('/assignments/giveGrade/{id}','AssignmentsController@giveGrade');
        Route::get('/assignments/giveFeedback/{id}','AssignmentsController@viewGrade');
        Route::post('/assignments/giveFeedback/{id}','AssignmentsController@giveFeedback');
        Route::get('/assignments/viewGradeFeedback/{id}','AssignmentsController@viewGradeFeedback');
        Route::get('/assignments/viewAssignment/{id}','AssignmentsController@viewAssignment');
        Route::get('/assignments/viewStudentAnwser/{id}','AssignmentsController@viewStudentAnwser');
        Route::get('/assignments/assignmentClasses/{id}','AssignmentsController@assignmentClasses');
        Route::get('/assignments/viewSchedule/{asid}/{clsid}','AssignmentsController@viewSchedule');
        Route::post('/assignments/saveAssgndraft/{asid}','AssignmentsController@saveAssgndraft');

        
        //Schedule Assignments
	Route::get('/scheduleAssignments','DashboardController@index');
	Route::get('/scheduleAssignments/listAll','ScheduleAssignmentsController@listAll');
        Route::post('/scheduleAssignments/setSchedule/{id}','ScheduleAssignmentsController@setSchedule');
        Route::get('/scheduleAssignments/getAssignment/{id}','ScheduleAssignmentsController@getAssignment');
        Route::post('/scheduleAssignments/removeSchedule/{id}','ScheduleAssignmentsController@removeSchedule');
        
        
        //Schedule OnlineExams
	Route::get('/scheduleOnlineExams','DashboardController@index');
	Route::get('/scheduleOnlineExams/listAll','ScheduleOnlineExamsController@listAll');
        Route::post('/scheduleOnlineExams/setSchedule/{id}','ScheduleOnlineExamsController@setSchedule');
        Route::get('/scheduleOnlineExams/getOnlineexams/{id}','ScheduleOnlineExamsController@getOnlineexams');
        Route::post('/scheduleOnlineExams/removeSchedule/{id}','ScheduleOnlineExamsController@removeSchedule');
	...
	Route::get('/messages/before/{from}/{to}/{before}','MessagesController@before');
        ...
        //Learn Path
	Route::get('/learnPath','DashboardController@index');
        Route::get('/learnPath/listAll','LearnPathController@listAll');
        Route::post('/learnPath/take/{id}','LearnPathController@take');
	Route::post('/learnPath/took/{id}','LearnPathController@took');
	Route::get('/learnPath/marks/{id}','LearnPathController@marks');
	Route::get('/learnPath/export/{id}/{type}','LearnPathController@export');
	Route::post('/learnPath','LearnPathController@create');
	Route::get('/learnPath/{id}','LearnPathController@fetch');
    Route::post('/learnPath/delete/{id}','LearnPathController@delete');
	Route::post('/learnPath/{id}','LearnPathController@edit');
        Route::get('/learnPath/viewLearnPath/{id}','LearnPathController@viewLearnPath');
       
        
        //Modules 
	Route::get('/modules','DashboardController@index');
	Route::get('/modules/listAll','ModulesController@listAll');
	Route::get('/modules/list/{id}','ModulesController@fetchSubs');
	Route::post('/modules','ModulesController@create');
	Route::get('/modules/{id}','ModulesController@fetch')->where(['id' => '[0-9]+', 'name' => '[a-z]+']);
    Route::post('/modules/delete/{id}','ModulesController@delete');
     Route::post('/modules/addnewModule/{text}','ModulesController@addnewModule');
	Route::post('/modules/{id}','ModulesController@edit');
	...
	Route::post('/onlineExams/{id}','OnlineExamsController@edit');
        Route::get('/onlineExams/onlineexamClasses/{id}','OnlineExamsController@onlineexamClasses');
        Route::get('/onlineExams/viewSchedule/{onid}/{clsid}','OnlineExamsController@viewSchedule');
