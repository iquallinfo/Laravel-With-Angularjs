schoex.config(function($routeProvider,$locationProvider) {
	...
	.when('/classgrade', {
      templateUrl : 'templates/classgrade.html',
      controller  : 'ClassesGradeController'
    })
	.when('/overrulegrade', {
      templateUrl : 'templates/overrulegrade.html',
      controller  : 'OverruleGradeController'
    })
    .when('/sections', {
	...
	.when('/scheduleAssignments', {
      templateUrl : 'templates/scheduleAssignments.html',
      controller  : 'ScheduleAssignmentsController'
    })
	
   .when('/scheduleOnlineExams', {
      templateUrl : 'templates/scheduleOnlineExams.html',
      controller  : 'ScheduleOnlineExamsController'
    })
    .when('/materials', {
	...
	.when('/learnPath', {
      templateUrl : 'templates/learnPath.html',
      controller  : 'learnPathController'
    })
	
	.when('/yearlevel', {
      templateUrl : 'templates/yearlevel.html',
	...
	.when('/languagesField', {
      templateUrl : 'templates/languageField.html',
...
schoex.directive('timepicker', function() {
return {
    restrict: 'A',
    scope: {
        time: "=ngModel"
...
schoex.directive('mobileNumber', function($parse, $timeout){
    return {
        ...
        link: function(scope, element, attrs,ngModel) {
            ...
            telInput.intlTelInput({utilsScript: "assets/js/utils.js",nationalMode: false});
